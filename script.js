// A set of card store in array of object
var arr_of_obj = new Set();

//A variable to store the current card.
var value_id;

// A boolean flag to track if a card's title is display.
...
function addSubtask(val) {
    document.getElementById("mainDivContainer").style.display = "block";
    value_id = val;
};
